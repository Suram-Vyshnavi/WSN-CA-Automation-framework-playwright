...
class NewUserPage(BasePage):
    ...
    def _select_dropdown(self, trigger_selector, option_selector, name):
        ...
        self._dismiss_overlays()
        self._click(trigger_selector, timeout=10000, required=True, name=f"{name} dropdown")
        self.page.wait_for_timeout(250)
        self._dismiss_overlays()
        self._click(option_selector, timeout=8000, required=True, name=f"{name} option")
    ...
    def click_create_new_and_enter_email(self):
        ...
        self._click(self.locators.CREATE_NOW_BUTTON, timeout=15000, required=True,
    ...
    def fill_personal_details(self):
        ...
        self._select_dropdown(self.locators.STATE_SEARCH_INPUT, self.locators.KARNATAKA_OPTION,
                              "State")
        self._click_and_fill(self.locators.CITY_INPUT, "Bengaluru", name="City")
        self._select_dropdown(self.locators.SELECT_GRADE, self.locators.CLASS_XI, "Grade")
        ...
        # Result: the welcome popup image should appear.
        self._validate(self.locators.WELCOME_IMAGE_POPUP, "welcome popup", timeout=15000)

    # ------------------------------------------------------------------
    # Welcome + passions + questionnaire entry
    # ------------------------------------------------------------------
    def validate_welcome_popup_and_next(self):
        self._wait_visible(self.locators.WELCOME_IMAGE_POPUP, timeout=15000, required=True,
    ...
    def select_passions_and_submit(self):
        ...
        self._validate(self.locators.QUESTIONNARIES_START_NOW_BUTTON, "questionnaire card",
                       timeout=15000)

    def click_questionnaire_card_start_now(self):
        self.handle_feedback_popup_if_present()
        self._click(self.locators.QUESTIONNARIES_START_NOW_BUTTON, timeout=15000, required=True,
                    name="Questionnaire Start Now button")
        # Result: the character-selection Start Now button should be present.
        self._validate(self.locators.START_NOW_BUTTON, "character selection", timeout=15000)
    ...
    def pick_male_character_and_start_now(self):
        ...
        if self.page.locator(self.locators.PICK_MALE_CHARACTER_IMAGE).count() == 0:
            self._click(self.locators.START_NOW_BUTTON, timeout=10000,
    ...
    def click_pick_roles_card(self):
        ...
        self._validate(self.locators.GOT_IT_BUTTON, "roles section (Got It)", timeout=12000)
    ...
    def click_first_job_and_save(self):
        ...
        self._click(self.locators.FIRST_SAVE_BUTTON, timeout=10000, required=True,
                    name="First Save button")

    def click_first_back(self):
        self._click(self.locators.FIRST_BACK_BUTTON, timeout=10000, required=True,
    ...
    def click_second_job_and_save(self):
        ...
        self._click(self.locators.SECOND_SAVE_BUTTON, timeout=10000, required=True,
                    name="Second Save button")

    def click_second_back(self):
        self._click(self.locators.SECOND_BACK_BUTTON, timeout=10000, required=True,
    ...
    def click_third_job_and_save(self):
        ...
        self._click(self.locators.THIRD_SAVE_BUTTON, timeout=10000, required=True,
                    name="Third Save button")

    def click_third_back(self):
        self._click(self.locators.THIRD_BACK_BUTTON, timeout=10000, required=True,
    ...
    def logout(self):
        ...
        # Result: back on the login/landing page.
        self._validate(self.locators.LOGIN_BUTTON, "login page after logout", timeout=15000)
